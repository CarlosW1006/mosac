...
<style scoped>
   ...
   /* 適應視窗比例 */
   @media screen and (max-width: 3000px) {  /* 桌機螢幕67%：完成 */
      /* 首頁-全局型態 */
      .v-card-title {
         height: 2.5em;
         font-size: 3.25em;
   ...
   @media screen and (max-width: 2000px) {  /* 筆電螢幕67%：完成 */
      /* 首頁-全局型態 */
      .v-card-title {
         height: 2.75em;
         font-size: 2.25em;
   ...
   @media screen and (max-width: 1800px) {  /* 筆電螢幕75%：完成 */
      /* 首頁-全局型態 */
      .v-card-title {
         height: 2.75em;
         font-size: 2em;
   ...
   @media screen and (max-width: 1600px){   /* 筆電螢幕80%：完成 */
      /* 首頁-全局型態 */
      .v-card-title {
         height: 2.75em;
         font-size: 2em;
   ...
   @media screen and (max-width: 1500px) {  /* 筆電螢幕90%：完成 */
      :deep(.v-progress-circular) {
         font-size: 1.75em;
      }
   }

   @media screen and (max-width: 1300px) {  /* 筆電螢幕100%：完成 */
      .target {
         font-size: 1.6em;
         margin-top: 0.6em;
      }
   ...
   @media screen and (max-width: 1200px) {  /* 手機螢幕比例：完成 */
      /* 首頁-全局型態 */
      .v-card-title {
         height: auto;
         font-size: 2em;
   ...
   @media screen and (max-width: 959px) {  /* 手機螢幕比例：sm */
      .v-card-R {
         margin-top: -2em;
      }
   }
