         ...
         <v-col cols="12" sm="12" md="5" lg="5" class="mb-4 v-card-RT">
                     ...
                     <!-- <div class="flex-container"> -->
                        <v-col cols="6" sm="6" md="5" lg="5">
                           <div class="flex-container target">
                              <h5 class="target-title">目標體重</h5><h5>65公斤</h5>
                           </div>
                           <div class="flex-container recent">
                              <h5 class="target-title">目前體重</h5><h5>70公斤</h5>
                           </div>
                        </v-col>
            ...
            <v-card outlined class="v-card-R mt-4">
               <v-card-title style="display: flex;">
                  群組目標達成率
                  <!-- <v-btn class="toGroupPage" href="#/groupRank" :ripple="false">更多</v-btn> -->
               </v-card-title>
               <v-card-text style="height: 100%;">
                  <v-row style="height: 95%;">
                     <!-- <div class="flex-container"> -->
                     <v-col cols="6" sm="6" md="5" lg="5">
                        <div class="flex-container target">
                           <h5 class="target-title">群組人數</h5><h5>30人</h5>
                        </div>
                        <div class="flex-container recent">
                           <h5 class="target-title">達成人數</h5><h5>18人</h5>
                        </div>
                     </v-col>
