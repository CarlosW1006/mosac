<template>
    ...
    <v-container fluid>
       ...
       <v-row justify="center">
             ...
             <template #day-content="{ day }">
                ...
                <div class="day-content" :style="{ backgroundColor: checkDay(day.date.toLocaleDateString()) }">
                   ...
                   <div v-else class="day-content-phone">
                      <button @click="navigate(day.date)">{{ day.date.getDate() }}</button>
                   </div>
                </div>
          ...
          <div v-if="winwidth == false" class="content">
             {{ today }} 健康紀錄
             <p class="contentList">123</p>
             <p class="contentList">123</p>
          </div>
       </v-row>
    </v-container>
...
.main-title {
 ...
 .vc-day.is-not-in-month *{ opacity: 1; color: #BDBDBD }
